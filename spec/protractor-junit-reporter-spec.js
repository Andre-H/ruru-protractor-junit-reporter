...
describe('Generate JUnit XML Report', function () {
    ...
    it('should create XML from JSON', function (done) {
        ...
        expect(fs.readFileSync('target/protractor-e2e-report-basic.xml')).toEqualFileContentsIgnoreLineBreaks('protractor-e2e-report-basic', done);
    });
    ...
    it('should be able to handle failed tests from JSON', function (done) {
        ...
        expect(fs.readFileSync('target/protractor-e2e-report-with-failures.xml')).toEqualFileContentsIgnoreLineBreaks('protractor-e2e-report-with-failures',done);
    });
    ...
    it('should treat passed tests with the duration of 0 as skipped', function (done) {
        ...
        expect(fs.readFileSync('target/protractor-e2e-report-with-skips.xml')).toEqualFileContentsIgnoreLineBreaks('protractor-e2e-report-with-skips',done);
    });
    ...
    it('should be able to handle a run without assertions', function (done) {
        ...
        expect(fs.readFileSync('target/protractor-e2e-report-without-assertion.xml')).toEqualFileContentsIgnoreLineBreaks('protractor-e2e-report-without-assertion',done);
    });
